  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="font-display text-2xl font-bold text-white flex-1">
          {course.title}
        </h1>
          ...
          .map((module: any) => (
            ...
            >
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-primary/20 text-primary border border-primary/30 text-xs px-4 py-2 rounded-xl hover:bg-primary/30 transition-all whitespace-nowrap"
                >
                  + Lección
                </button>
              </form>
      ...
      <div className="glass rounded-2xl p-5 border border-white/5">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-primary text-white text-sm px-5 py-2.5 rounded-xl hover:bg-primary-dark transition-all"
          >
            + Módulo
          </button>
        </form>
